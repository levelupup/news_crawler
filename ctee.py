...
工商時報（ctee.com.tw）封鎖直接 HTTP 請求（Cloudflare WAF 403），
...
_SUFFIXES = [" - 工商時報", " - 工商時報 ctee.com.tw"]


def fetch_ctee(count: int = 50) -> list[dict]:
    """Return up to `count` 工商時報 articles."""
...
if __name__ == "__main__":
    ...
    articles = fetch_ctee(count=20)
    print(f"Found {len(articles)} 工商時報 articles:\n")
